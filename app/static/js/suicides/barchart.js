...
// 12460796
// Description:
// This script makes a bar chart on the visualizations page
// source: https://github.com/rushkock/dataprocessing/blob/master/homework/week_4/index.html
  ...
  rect.attr('fill', function (d) { return color(d.suicides_per_10000); })
      .on('mouseover', function (d) {
            ...
            myTool.html('<div id="thumbnail"><span>' + d.country + ': ' +
                         Math.round(d.suicides_per_10000) + '</span></div>')
