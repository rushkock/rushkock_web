...
{
  var requests = [d3.json('static/data/terrorism/world_countries.json'),
                  d3.json('static/data/terrorism/attacks.json'),
                  d3.json('static/data/terrorism/attacks.json'),
                  d3.json('static/data/terrorism/attacks_type.json'),
                  d3.json('static/data/terrorism/gname.json'),
                  d3.json('static/data/terrorism/target_type.json'),
                  d3.json('static/data/terrorism/nkill_and_nwound.json'),
